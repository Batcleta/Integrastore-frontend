    ...
    connectedCallback() {
        ...
        <div class="nav">
            <div>
                <div class="nav__brand">
                    ...
                    <a href="#" class="nav__logo">
                        <img src="" alt="logo integra store" srcset="">
                    </a>
                </div>
                ...
                <div class="nav__list">
                    ...
                    <div class="nav__link nav_active nav_collapse">
                        ...
                        <i class="collapse__link__arrow"></i>
            ...
            <a href="#" class="nav__link">
                <svg class="nav__icon" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none">
